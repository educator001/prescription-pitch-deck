...
var c; // ScrollMagic controller

var s01, s02, s03, s04, s05, s06, s07, s08, s09, s10, s11,
	s12, s13, s14, s15, s16, s17, s18, s19, s20, s21; // scenes
...
function makeMagic() { // only needs to be called once
...
function chooseMobile() {
	...
	document.getElementById("target").style.top = "50%";
	document.getElementById("target").style.left = "50%";
	// document.getElementById("target").style.marginRight = "-50%";
	document.getElementById("target").style.transform = "translate(-50%, -50%)";
